...
CREATE TABLE `property` (
  ...
  `total_floors` varchar(3) NOT NULL,
  `room_floor` varchar(3) NOT NULL,
  `loan` varchar(50) NOT NULL,
  `lift` varchar(7) NOT NULL DEFAULT 'no',
  `security_guard` varchar(15) NOT NULL DEFAULT 'no',
  `play_ground` varchar(10) NOT NULL DEFAULT 'no',
  `garden` varchar(9) NOT NULL DEFAULT 'no',
  `water_supply` varchar(10) NOT NULL DEFAULT 'no',
  `power_backup` varchar(6) NOT NULL DEFAULT 'no',
  `parking_area` varchar(8) NOT NULL DEFAULT 'no',
  `gym` varchar(7) NOT NULL DEFAULT 'no',
  `shopping_mall` varchar(10) NOT NULL DEFAULT 'no',
  `hospital` varchar(20) NOT NULL DEFAULT 'no',
  `school` varchar(10) NOT NULL DEFAULT 'no',
  `market_area` varchar(20) NOT NULL DEFAULT 'no',
...
CREATE TABLE `requests` (
  `id` varchar(20) NOT NULL,
  `property_id` varchar(28) NOT NULL,
